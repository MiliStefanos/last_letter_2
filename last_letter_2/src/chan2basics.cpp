...
last_letter_2_msgs::input_signals input_signals;
last_letter_2_msgs::control_signals joy_control_signals;

void chan2input(last_letter_2_msgs::joystick_input msg)
{
...
int main(int argc, char **argv)
{
    ...
    control_signals_pub = n.advertise<last_letter_2_msgs::control_signals>("last_letter_2/Joy_signals", 1);
