// A node where the controller for hexacopter model runs
...
void Controller::initControllerVariables()
{
   ...
   multirotor_matrix <<  0.1667,   0.1667,   0.1667,   0.1667,   0.1667,   0.1667,  //thrust row
                              0,  -0.2500,  -0.2500,        0,   0.2500,   0.2500,  //roll row
                         0.3333,   0.1667,  -0.1667,  -0.3333,  -0.1667,   0.1667,  //pitch row
                        -0.3333,   0.0833,  -0.0833,   0.3333,  -0.0833,   0.0833;  //yaw row   
